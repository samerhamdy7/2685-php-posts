        ...
        <form action="store.php" method="POST" novalidate>
            ...
            <div class="mb-4 flex space-x-4 ">
                <div class="w-1/2">
                    ...
                    <span
                        class='text-red-500 font-bold bg-black border-xl p-2 rounded-xl'><?= @$errors['first_name_err']?></span>
                </div>
                <!-- LastName -->
                <div class="w-1/2">
                    ...
                    <span
                        class='text-red-500 font-bold bg-black border-xl p-2 rounded-xl'><?= @$errors['last_name_err']?></span>
            ...
            <div class="mb-4 flex space-x-4">
                ...
                <div class="w-1/2">
                    ...
                    <input type="text" name="mobile" required class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 
