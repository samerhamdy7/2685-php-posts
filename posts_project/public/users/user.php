...
function time_stamp($time) 
    ...
    if (isset($user) && is_array($user)) {
        $roles = isset($user['roles']) ? $user['roles'] : 'guest';
        ...
        echo "<div class='border-2 border-gray-900 text-white bg-black flex justify-center items-center rounded-xl'>
            <span style='color: $background' class='font-bold text-xl uppercase' style='color: $color'>$roles</span>
            <h2 class='flex justify-center items-center font-bold p-4 uppercase'>$name</h2>
            </div>";
        ...
        echo "<p class='border-2 border-black text-blue font-bold flex justify-center items-center p-4 rounded-xl gap-4 bg-gray-900 m-1'>
            The Posts Of <span style='color: $background;' style='color: $color'>$name</span>
            </p>";
    }
                    ...
                    <div class="flex flex-col gap-4 w-full mt-4">
                        ...
                        <div class="border-2 p-2 rounded-xl bg-white">
                            <div style="color: <?= $color ?>" class="font-bold">
                                <span class='bg-black rounded-xl flex gap-4 p-2'><?= $reply['name'] ?> <span
                                        class='text-white'> Reply</span></span>
                            </div>
